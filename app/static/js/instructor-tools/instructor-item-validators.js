 $(document).ready(function() {
    ...
    $('#author_name').on('input', function() {
        ...
        var maxAuthorNameLength = 50; // You can adjust this value as needed
        var errorElement = $('#authorNameError');
        if (authorName === '') {
            showSuccess(authorNameField); // Empty field is allowed
            errorElement.text('');
        } 
    ...
    $('#job_title').on('input', function() {
        ...
        if (jobTitle.length <= 100 || jobTitle === '') {
    ...
    $('#course_title').on('input', function() {
        ...
        if (courseTitle.length <= 155 || courseTitle === '') {
    ...
    $('#short_description').on('input', function() {
        ...
        if (description.length <= 265 || description === '') {
